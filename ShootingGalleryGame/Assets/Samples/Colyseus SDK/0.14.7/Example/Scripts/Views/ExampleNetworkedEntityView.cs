...
public class ExampleNetworkedEntityView : ColyseusNetworkedEntityView
{
    ...
    public void InitiView(ExampleNetworkedEntity entity)
    {
        ...
        {
            state = entity;
            IsMine = ExampleManager.Instance.Avatar.ToString() == prefabName
                && ExampleManager.Instance.CurrentUser != null
                && string.Equals(ExampleManager.Instance.CurrentUser.id, state.ownerId);
